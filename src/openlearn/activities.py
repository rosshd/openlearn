...
def validate_activity(activity: Mapping[str, object]) -> dict[str, object]:
    """Validate persisted activity state without invoking an adapter."""
    if activity.get("schema_version") != ACTIVITY_SCHEMA_VERSION:
    ...
    if not isinstance(refs, list):
        raise ActivityContractError("evidence_refs must be a list")
